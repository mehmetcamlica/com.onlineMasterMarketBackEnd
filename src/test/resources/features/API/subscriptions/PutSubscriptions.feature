Feature: Access Subscription Details
  ...
  Scenario: Valid request with correct data
    Given I set the subscription endpoint "api/subscription_details/2"
  ...
  Scenario: Request with valid authorization and correct data
    ...
    And the response should contain the following details:
      ...
      | currency_code    | USD           |
      | duration         | 1 year        |
      | fee_description  | Annual Fee    |
      | subscription_content | Basic Content |
