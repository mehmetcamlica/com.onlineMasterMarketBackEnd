...
Feature:
  ...
  Scenario Outline:TC001- When a GET request with valid authorization information and correct data (id) is sent to the /api/category_details/{id} endpoint,
  it should be verified that the status code returned is 200 and the response_message in the response body is "Category  Details".
    ...
    * The api user verifies that the "response.response_message" information in the response body is "Category  Details" Gokcen.
    ...
    Scenario Outline:TC002-When a GET request with valid authorization information and correct data (id) is sent to the /api/category_details/{id} endpoint,
  ...
  Scenario Outline:TC003- When a GET request is sent to the /api/category_details/{id} endpoint that does not contain
  ...
  Scenario Outline: TC004-When sending a GET request to the /api/category_details/{id} endpoint with valid authorization information and an unregistered (id),
  ...
  Scenario Outline:TC005- When a GET request is sent to the /api/category_details/{id} endpoint with invalid (invalid API key) authorization information,
